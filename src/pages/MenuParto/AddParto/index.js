  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Adicione um parto</Text>
        <Feather
          name="arrow-left"
          size={30}
          color="#000000"
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => (
          <View style={styles.body}>
            <Text style={styles.text}>Data do parto</Text>
            <DateField
            value={dataDeInicio}
              labelDate="Dia"
              labelMonth="Mês"
            ...
            />
            <Text style={styles.text}>Data de insiminação</Text>
            <DateField
              labelDate="Dia"
              labelMonth="Mês"
              labelYear="Ano"
            ...
            />
            <Text style={styles.text}>Registro do parto</Text>
            <TextInput
              style={styles.input}
              value={idVaca}
